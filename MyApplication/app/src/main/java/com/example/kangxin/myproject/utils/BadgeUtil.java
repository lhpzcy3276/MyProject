...
public class BadgeUtil {
    ...
    public static void setBadgeCount(Context context,int count,int iconResId){
        ...
        LogUtil.d("打印数据---"+Build.MANUFACTURER);
    ...
    private static void setBadgeOfMIUI(Context context, int count, int iconResId) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtil.e("打印一下数据表"+e.getMessage());
        }
...
// com.example是包名，com.example.MainActivity是启动页类名
        ...
        Intent.ShortcutIconResource iconRes = Intent.ShortcutIconResource.fromContext(context, R.mipmap.activity_delate_image); // 快捷方式的图标
